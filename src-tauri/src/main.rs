...
#[cfg(windows)]
const APP_UPDATE_MANIFEST_URL: &str = "https://github.com/rselbach/LlamaProxy/releases/latest/download/portable-update-windows.json";
#[cfg(target_os = "linux")]
const APP_UPDATE_MANIFEST_URL: &str = "https://github.com/rselbach/LlamaProxy/releases/latest/download/portable-update-linux.json";
...
#[cfg(target_os = "macos")]
const APP_UPDATE_MANIFEST_URL: &str = "https://github.com/rselbach/LlamaProxy/releases/latest/download/portable-update-darwin-v2.json";
const APP_RELEASE_DOWNLOAD_PREFIX: &str =
    "https://github.com/rselbach/LlamaProxy/releases/download/";
#[cfg(windows)]
...
const CODEX_MODEL_CATALOG_URL: &str = "https://raw.githubusercontent.com/rselbach/LlamaProxy/main/src-tauri/resources/codex_models/model-catalog.json";
...
#[cfg(windows)]
const PORTABLE_APP_BINARY: &str = "LlamaProxy.exe";
#[cfg(target_os = "linux")]
const PORTABLE_APP_BINARY: &str = "LlamaProxy";
...
const MANAGED_CLAUDE_OPUS_ALIAS_DISPLAY_NAME: &str = "LlamaProxy managed Claude Opus mapping";
const MANAGED_CLAUDE_SONNET_ALIAS_DISPLAY_NAME: &str = "LlamaProxy managed Claude Sonnet mapping";
const MANAGED_CLAUDE_HAIKU_ALIAS_DISPLAY_NAME: &str = "LlamaProxy managed Claude Haiku mapping";
...
const APP_USER_AGENT: &str = concat!(
    "LlamaProxy/",
    env!("CARGO_PKG_VERSION"),
    " (+https://github.com/rselbach/LlamaProxy)"
);
...
fn locale_text<'a>(locale: &str, zh_cn: &'a str, en: &'a str) -> &'a str {
    match normalize_app_locale(locale) {
        ...
        "zh-TW" => match zh_cn {
            ...
            "启动内核" => "啟動核心",
            "重启内核" => "重新啟動核心",
            "LlamaProxy · 内核处理中" => "LlamaProxy · 核心處理中",
            "LlamaProxy · 内核未安装" => "LlamaProxy · 核心未安裝",
            "LlamaProxy · 内核运行中" => "LlamaProxy · 核心執行中",
            "LlamaProxy · 内核已停止" => "LlamaProxy · 核心已停止",
            "LlamaProxy · 内核操作失败" => "LlamaProxy · 核心操作失敗",
            "内核状态：正在检查" => "核心狀態：正在檢查",
            _ => zh_cn,
        },
        "ja" => match zh_cn {
            ...
            "启动内核" => "コアを起動",
            "重启内核" => "コアを再起動",
            "LlamaProxy · 内核处理中" => "LlamaProxy · コア処理中",
            "LlamaProxy · 内核未安装" => "LlamaProxy · コア未インストール",
            "LlamaProxy · 内核运行中" => "LlamaProxy · コア実行中",
            "LlamaProxy · 内核已停止" => "LlamaProxy · コア停止済み",
            "LlamaProxy · 内核操作失败" => "LlamaProxy · コア操作失敗",
            "内核状态：正在检查" => "コア状態：確認中",
            _ => zh_cn,
        },
        _ => zh_cn,
